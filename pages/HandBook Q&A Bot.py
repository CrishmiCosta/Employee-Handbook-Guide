#Open AI Bot to Answer Any Questions on the Handbook
...
#Document Tokenization and Embedding
# Document Loading
loader = PyPDFLoader('handbookdocs/AloraGuide.pdf')
...
question = st.text_input(
    "Ask me any questions you have on the Handbook",
